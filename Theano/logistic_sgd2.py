...
path = '/home/dl-box/Liver/create_bin'
...
class LogisticRegression(object):
    ...
    def __init__(self, input, n_in, n_out):
        ...
        #self.p_y_given_x = T.nnet.(T.dot(input, self.W) + self.b)
    ...
    def negative_log_likelihood(self, y):
        ...
        #return (1.0 / y.shape[0]) * T.sum(-y * T.log(self.p_y_given_x) - (1 - y) * T.log(1 - self.p_y_given_x))
        return (-1)*T.mean(T.log(self.p_y_given_x)[T.arange(y.shape[0]), y])

   
    def makefile1(self, y):
        #if y.dtype.startswith('int'):
        a = T.neq(self.y_pred,y)
        return T.neq(a,y)
